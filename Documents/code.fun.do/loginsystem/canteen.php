...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    if (isset($_POST['login'])) { //user logging in
        $cname=$_POST['cname'];
        $result = $mysqli->query("SELECT * FROM canteen WHERE cname='$cname'");
        ...
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="canteen.php">
                        ...
                        <div class="content">
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" class="form-control" placeholder="Canteen name" name="cname">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                        ...
                        <!-- <p style="z-index:2;"> <?php if (isset($_SESSION['message'])){echo $_SESSION['message'];} ;?></p> -->
