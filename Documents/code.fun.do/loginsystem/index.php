...
{
    if (isset($_POST['login']) AND !empty($_POST['enroll'])) { //user logging in
...
<body class="login-page sidebar-collapse">
    ...
    <div class="page-header" filter-color="orange">
        <div class="page-header-image" style="background-image:url(1/img/login.jpg);width:100%;height:100%;"></div>
        <div class="container">
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="post" action="index.php">
                        ...
                        <!-- <p style="z-index:2;"> <?php   if (isset($_SESSION['message'])) {$message= $_SESSION['message'];echo $message;} $_SESSION['message']=NULL;?></p>  -->
